package top.lucifer.tinyDB.backend.parser;

import java.util.ArrayList;
import java.util.List;

import top.lucifer.tinyDB.backend.parser.statement.Abort;
import top.lucifer.tinyDB.backend.parser.statement.Begin;
import top.lucifer.tinyDB.backend.parser.statement.Commit;
import top.lucifer.tinyDB.backend.parser.statement.Create;
import top.lucifer.tinyDB.backend.parser.statement.Delete;
import top.lucifer.tinyDB.backend.parser.statement.Drop;
import top.lucifer.tinyDB.backend.parser.statement.Insert;
import top.lucifer.tinyDB.backend.parser.statement.Select;
import top.lucifer.tinyDB.backend.parser.statement.Show;
import top.lucifer.tinyDB.backend.parser.statement.SingleExpression;
import top.lucifer.tinyDB.backend.parser.statement.Update;
import top.lucifer.tinyDB.backend.parser.statement.Where;
...
public class Parser {
    ...
    private static Show parseShow(Tokenizer tokenizer) throws Exception {
        ...
        if("".equals(tmp)) {
            Show show = new Show();
            show.values = new String[1];
            show.values[0] = "tables";
            show.tableName = "null";
            return show;
        }
        throw Error.InvalidCommandException;
